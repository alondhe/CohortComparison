...
#' (NOT WORKING YET) Wrapper for FeatureExtraction to generate covariates of cohort
#'
...
#' (NOT WORKING YET) Get Plot Covariates
...
getMetadata <- function(targetId, comparatorId)
{
  ...
  meta$yTitle <- gsub(pattern = ">", replacement = "greater than", x = meta$yTitle)
  
  meta$chartTitle <- Sys.getenv("cdmDbName")
  return (meta)
}
